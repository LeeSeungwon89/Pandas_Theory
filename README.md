...
오늘은 첫 번째 프로젝트를 마치고 비로소 새로운 과정을 시작하는 뜻깊은 날입니다. 앞으로는 한동안 데이터 분석과 과학을 실현하는 도구인 파이썬의 활용법을 정리할 계획입니다. 추후 프로그래밍 실전에서 개념을 망각했을 경우에 참고할 수 있는 자료를 마련하는 차원으로도 큰 의미를 지닙니다.
